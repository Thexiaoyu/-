...
public class ProcedureRjbd extends ElementsXiaoyuMod.ModElement {
	public ProcedureRjbd(ElementsXiaoyuMod instance) {
		super(instance, 41);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Rjbd!");
			return;
		}
