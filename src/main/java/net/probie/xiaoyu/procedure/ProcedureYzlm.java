...
public class ProcedureYzlm extends ElementsXiaoyuMod.ModElement {
	public ProcedureYzlm(ElementsXiaoyuMod instance) {
		super(instance, 46);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Yzlm!");
			return;
		}
