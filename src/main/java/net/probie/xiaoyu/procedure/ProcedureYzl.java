...
public class ProcedureYzl extends ElementsXiaoyuMod.ModElement {
	public ProcedureYzl(ElementsXiaoyuMod instance) {
		super(instance, 45);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Yzl!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		{
			...
			if (!_ent.world.isRemote && !_ent.isRiding() && !_ent.isBeingRidden() && _ent instanceof EntityPlayerMP) {
				int dimensionID = WorldXiaoyuworld.DIMID;
