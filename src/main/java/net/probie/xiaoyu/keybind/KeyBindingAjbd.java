...
package net.probie.xiaoyu.keybind;

import org.lwjgl.input.Keyboard;

import net.probie.xiaoyu.procedure.ProcedureZbcdopen;
...
public class KeyBindingAjbd extends ElementsXiaoyuMod.ModElement {
	private KeyBinding keys;
	public KeyBindingAjbd(ElementsXiaoyuMod instance) {
		super(instance, 40);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.ajbd", Keyboard.KEY_K, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				XiaoyuMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureZbcdopen.executeProcedure($_dependencies);
		}
	}
}
